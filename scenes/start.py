...
class Start(Scene):
    ...
    def __init__(self, game):
        ...
        self.objects.append(Button(self, Window.WIDTH // 2, (Window.HEIGHT // 2) + 50, 200, 50, Color.BLUE, lambda: game.choose_level(), "CHOOSE", Color.BLACK, Font.FONT1, center = True))
